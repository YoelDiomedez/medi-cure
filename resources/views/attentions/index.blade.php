...
@push('scripts')
    ...
    <script src="{{ asset('assets/global/plugins/moment-with-locales.min.js') }}"></script>
    <script src="{{ asset('assets/global/plugins/moment-duration-format.js') }}"></script>
    ...
    function ageFormat(birthdate) {
        ...
        var diff  = moment.duration(moment(date).diff(birthdate))
